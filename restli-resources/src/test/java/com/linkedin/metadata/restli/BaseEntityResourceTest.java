...
public class BaseEntityResourceTest extends BaseEngineTest {
  ...
  public void testGet() {
    ...
    AspectKey<FooUrn, AspectVersioned> aspect5Key = new AspectKey<>(AspectVersioned.class, urn, LATEST_VERSION);
  ...
  public void testBatchGet() {
    ...
    AspectKey<FooUrn, AspectVersioned> aspectVerKey1 = new AspectKey<>(AspectVersioned.class, urn1, LATEST_VERSION);
    ...
    AspectKey<FooUrn, AspectVersioned> aspectVerKey2 = new AspectKey<>(AspectVersioned.class, urn2, LATEST_VERSION);

    when(_mockLocalDAO.get(ImmutableSet.of(aspectFooBarKey1, aspectFooBarKey2, aspectFooKey1, aspectBarKey1, aspectFooKey2,
        aspectBarKey2, aspectAttKey1, aspectAttKey2, aspectVerKey1, aspectVerKey2)))
  ...
  public void testGetSnapshotWithAllAspects() {
    ...
    AspectVersioned versioned = new AspectVersioned().setValue("ver");
    ...
    AspectKey<FooUrn, ? extends RecordTemplate> verKey = new AspectKey<>(AspectVersioned.class, urn, LATEST_VERSION);

    Set<AspectKey<FooUrn, ? extends RecordTemplate>> aspectKeys = ImmutableSet.of(fooKey, barKey, fooBarKey, attKey, verKey);
    when(_mockLocalDAO.get(aspectKeys)).thenReturn(ImmutableMap.of(fooKey, Optional.of(foo), barKey, Optional.of(bar),
        fooBarKey, Optional.of(fooBar), attKey, Optional.of(attributes), verKey, Optional.of(versioned)));
    ...
    assertEquals(aspects, ImmutableSet.of(foo, bar, fooBar, attributes, versioned));
  }
  ...
  public void testFilterFromIndexWithAspects() {
    ...
    when(_mockLocalDAO.getAspects(ImmutableSet.of(AspectFoo.class, AspectBar.class, AspectFooBar.class, AspectAttributes.class, AspectVersioned.class), indexFilter, null, urn1, 2))
